            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    while ($data = mysqli_fetch_array($result)) {
                        ...
                        echo "<td>
                            <a href='../ubah/ubah_mahasiswa.php?npm_1=" . $data['npm_1'] . "' class='btn btn-warning btn-sm'><i class='bi bi-pencil'></i></a> 
                            <a href='#' onclick='confirmDelete(" . $data['npm_1'] . ")' class='btn btn-danger btn-sm'><i class='bi bi-trash'></i></a>
                        </td>";
                        echo "</tr>";
                    }
                    ?>
