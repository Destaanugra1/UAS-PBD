  ...
  <div class="container">
    ...
    <form method="post" action="../aksi/konfrensi_aksi.php">
      <table class="table table-striped table-bordered">
        <tr>
          <td>ID Konferensi</td>
          <td><input type="number" name="id_konferensi_1" class="form-control" maxlength="10"></td>
        </tr>
        <tr>
          <td>ID Penelitian</td>
        ...
        <tr>
          ...
          <td><input type="text" name="nama_konferensi_1" class="form-control"></td>
        </tr>
        <tr>
          <td>Lokasi</td>
          <td><input type="text" name="lokasi_1" class="form-control"></td>
        </tr>
        <tr>
          <td>Tanggal</td>
          <td><input type="date" name="tanggal_1" class="form-control"></td>
        </tr>
        <tr>
          <td></td>
