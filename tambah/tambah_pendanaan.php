  ...
  <div class="container">
    ...
    <form method="post" action="../aksi/pendanaan_aksi.php">
      <table class="table table-striped table-bordered">
        <tr>
          <td>ID Pendanaan</td>
          <td><input type="number" name="id_pendanaan_1" class="form-control" maxlength="15"></td>
        </tr>
        <tr>
          <td>ID Penelitian</td>
        ...
        <tr>
          ...
          <td><input type="text" name="nama_pemberi_dana_1" class="form-control"></td>
        </tr>
        <tr>
          <td>Jumlah Dana</td>
        ...
        <tr>
          <td>Tahun</td>
          <td><input type="number" name="tahun_1" class="form-control"></td>
        </tr>
        <tr>
          <td></td>
